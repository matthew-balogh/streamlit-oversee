...
@with_dive_filepath()
def load_dive(dive_filepath: Path):
...
@with_dive_filepath()
def save_dive(text: str, dive_filepath: Path):
...
@with_dive_filepath()
def delete_dive(dive_filepath: Path):
    if os.path.exists(dive_filepath):
        os.remove(dive_filepath)

@with_manuscript_dives_filepath()
def record_dive(manuscript_id: str, dive: object, manuscript_dives_filepath: Path):
