...
from oversee.utilities.decorators import with_new_manuscript_id, with_manuscript_folder, with_manuscript_folders
...
def get_manuscript_folder(manuscript_id: str, manuscript_folder: Path):
    return manuscript_folder

@with_new_manuscript_id()
@with_manuscript_folder()
def new_case(manuscript_title: str, research_objective: str, manuscript_folder: Path, manuscript_id: str):
    create_manuscript_from_template(manuscript_folder, manuscript_id, manuscript_title, research_objective)
    return manuscript_id

@with_manuscript_folders()
def get_cases(manuscript_folders: list[Path]):
    cases = []
    for dirurl in manuscript_folders:
...
@with_manuscript_folder()
def get_case(manuscript_id: str, manuscript_folder: Path):
    case = None
